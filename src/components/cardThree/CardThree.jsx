...
export default function CardThree() {
  ...
  let travelDesc = 'We want you to enjoy your travels. This is why we don\'t charge any fees on purchases while you\'re abroad. We\'ll even show you...'
  let travelAuthor = 'Claire Robinson'

  let betaTitle = ' Our invite-only Beta accounts are now live!'
  let betaDesc = 'After a lot of hard work by the whole team, we\re excited to launch our closed beta. It\'s easy to request an invite through the site...'

  return (
    <>
        <div className="flex flex-col items-start justify-start xl:px-40 bg-mGrey/10">
          ...
          <div className="flex flex-row items-start justify-between xl:w-full xl:h-full xl:pb-32 xl:pt-10">
              ...
              <Article img={planePhoto} title={travelTitle} description={travelDesc} author={moneyAuthor} />
