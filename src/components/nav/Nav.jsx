...
import PagesUL from "./pagesUL";
import ReqDemoBtn from "../buttons/ReqDemoBtn";

export default function () {
  return (
    <>
      <div className="fixed top-0 z-50 w-screen bg-white/60 backdrop-blur-xl">
        <div className="w-full h-20 md:flex md:flex-row md:justify-around md:items-center">
